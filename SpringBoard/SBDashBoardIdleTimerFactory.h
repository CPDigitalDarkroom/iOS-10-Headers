...
- (_Bool)updateSettingsForTappedAfterWarn:(CDStruct_94962e32 *)arg1 logBuilder:(id)arg2;
...
- (CDStruct_94962e32)idleTimerSettingsForDuration:(long long)arg1 warnMode:(long long)arg2 timerMode:(long long)arg3 logBuilder:(id)arg4;
