...
@class NSArray, NSDictionary, NSMutableArray, NSString, NSTimer, SBActivationInfoViewController, SBAppStatusBarSettingsAssertion, SBSetupManager, SBSetupRegulatoryInfoViewController;
