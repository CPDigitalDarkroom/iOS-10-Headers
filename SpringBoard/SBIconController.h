...
- (void)appIconForceTouchController:(id)arg1 shareApplicationForGestureRecognizer:(id)arg2;
- (_Bool)appIconForceTouchController:(id)arg1 shouldShowShareApplicationShortcutItemForGestureRecognizer:(id)arg2;
...
- (_Bool)_isShowingSlideOverSearch;
...
- (_Bool)isTransitioningFromCancelledCollapse;
