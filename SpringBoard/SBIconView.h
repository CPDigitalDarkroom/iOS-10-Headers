...
@class NSString, NSTimer, SBCloseBoxView, SBFParallaxSettings, SBFolderIconBackgroundView, SBIcon, SBIconImageCrossfadeView, SBIconImageView, UIGestureRecognizer, _UILegibilitySettings;
@protocol SBIconAccessoryView, SBIconLabelView, SBIconViewDelegate, SBIconViewObserver, SBReusableView;
