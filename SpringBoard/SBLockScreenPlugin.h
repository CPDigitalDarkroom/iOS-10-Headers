...
@class BSPluginBundle, FBProcess, NSString, SBDashBoardAppearance, SBDashBoardBehavior, SBLockOverlayContext, SBLockScreenPluginAction, SBLockScreenPluginAppearanceContext, UIViewController;
