...
@class NSHashTable, NSMutableSet, NSString, SBComposedWallpaperSpecification, SBFFileCache, SBFWallpaperConfigurationManager, SBFWallpaperView, SBWallpaperAggdLogger, SBWallpaperControllerCoordinator, SBWallpaperPreviewSnapshotCache, SBWallpaperStyleInfo, UIImage, UIView, UIWindow;
@protocol SBDashBoardWallpaperOverlay, SBFIrisWallpaperView;
...
- (id)_newFakeBlurViewForVariant:(long long)arg1 style:(long long)arg2 transformIgnoresRotation:(_Bool)arg3;
...
@property(readonly, nonatomic) _Bool darkensHomeScreenStaticWallpaperToEnsureLegibility;
- (_Bool)supportsDarkeningWallpaperToEnsureLegibilityForWallpaperType:(long long)arg1;
- (_Bool)darkensWallpaperToEnsureLegibilityForVariant:(long long)arg1 wallpaperType:(long long)arg2;
- (_Bool)_canShareWallpaperViewsForSharedWallpaperType:(long long)arg1;
- (_Bool)variantsWouldShareWallpaperIfNotForHomeScreenTreatment;
...
- (unsigned long long)_bestStaticWallpaperViewInitializationOptionsForVariant:(long long)arg1 shared:(_Bool)arg2;
