...
- (void)statusBarStateAggregator:(id)arg1 didUpdateNonItemData:(const CDStruct_5e10f1a5 *)arg2;
...
- (_Bool)_shouldPostForUpdatesToNonItemData:(const CDStruct_5e10f1a5 *)arg1;
