...
@class BBDataProviderConnection, NSDate, NSHashTable, NSMutableArray, NSMutableSet, NSNumberFormatter, NSObject, NSSet, NSString, NSTimer, SBAppStatusBarSettingsAssertion, SBApplication, SBBluetoothAccessoryBatteryMonitor, SBCardItemsController, SBCombinationHardwareButton, SBFUserAuthenticationController, SBHomeHardwareButton, SBLockHardwareButton, SBModalAlertPresentationCoordinator, SBModalAlertPresenter, SBNCNotificationDispatcher, SBPowerDownController, SBRestartManager, SBSStatusBarStyleOverridesAssertion, SBScreenshotManager, SBSynchronizeCloudCriticalDataOperation, SBUIController, SBUserSessionController, SBWidgetController, UIWindow;
...
- (_Bool)_effectiveLanguageDirectionalityDiffersBetweenOldLanguages:(id)arg1 newLanguages:(id)arg2;
...
- (void)_runDashBoardDismissTestFromPageIndex:(long long)arg1 showPasscodeView:(_Bool)arg2;
...
- (void)_runDashBoardRotationTestOnPageAtIndex:(long long)arg1 showSpotlight:(_Bool)arg2;
- (void)_runDashBoardRotationTestOnPageAtIndex:(long long)arg1;
...
- (void)_runDashBoardScrollTestFromPageIndex:(long long)arg1 toPageWithIndex:(long long)arg2 subTestName:(id)arg3 backSubTestName:(id)arg4 withBlur:(_Bool)arg5;
...
- (void)_publishFakeNotificationsWithCount:(long long)arg1;
