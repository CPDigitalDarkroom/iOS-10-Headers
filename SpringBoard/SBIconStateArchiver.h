...
+ (id)_chunkIconList:(id)arg1 chunkSize:(unsigned long long)arg2 folderChunkSize:(unsigned long long)arg3;
+ (id)_chunkIconLists:(id)arg1 chunkSize:(unsigned long long)arg2 folderChunkSize:(unsigned long long)arg3;
+ (id)transformIconModelForLanguageDirectionalityChange:(id)arg1;
