...
#import "SBCompoundIdleTimerDelegate-Protocol.h"
...
- (void)reset;
- (id)initWithCompoundTimer:(id)arg1 warnOnly:(_Bool)arg2 resetPolicy:(long long)arg3;
- (id)initWithWarnTimer:(id)arg1 expireTimer:(id)arg2 resetPolicy:(long long)arg3;
- (id)init;
